...
# modelo clasificador
class LSTMsuper(nn.Module):
    def __init__(self, input_size, hidden_size, hidden_size2, hidden_size3, num_layers, output_size, batch_size, model):
        super(LSTMsuper, self).__init__()
